...
### 前言
为了让同学们更加认真更加专注听课，而不去用手机签到花费大量时间耗费大量精力，特此在[原脚本](https://github.com/mkdir700/chaoxing_auto_sign)中开发升级，请自行合理使用！挂科请不要找我，谢谢合作！请点击下方View all of README.md了解更多。
...
2、无需挂在任何服务器上，只需要点几下让github自动为你签到。<br>
